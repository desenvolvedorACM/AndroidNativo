...
public class adapterPersonagens extends BaseAdapter {
    ...
    private ArrayList<ModelPersonagem> listaPersonagem;
    private LayoutInflater inflater;
    public ViewHolder mViewHolder = new ViewHolder();

    public adapterPersonagens(Context context, ArrayList<ModelPersonagem> listaPersonagem) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            this.mViewHolder.txt_Id = (TextView) convertView.findViewById(R.id.text_id);
            this.mViewHolder.txt_Nome = (TextView) convertView.findViewById(R.id.text_nome);
    ...
    public static class ViewHolder {
        ...
        TextView txt_Id, txt_Nome, txt_Descricao;
    }
}
